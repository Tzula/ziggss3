...
<div class="archive" style="width:1000px;height:auto;min-height:690px;margin:20px auto;">
	<div class="index_content" style="width:1000px;height:auto;min-height:690px;margin:20px auto;">
		...
		<div class="index_content_posts" style="margin:10px auto;width:1000px;float:left;">
			 <?php
				...
				if ($query->have_posts()) 
				{
					...
					{
						$query->the_post();
						echo '<div class="index_content_posts_grid_post" style="float:left;margin:5px 5px;height:300;width:320px;">';
...
<div class="archive" style="margin-bottom:0px;width:100%px;max-height:200px;margin-top:10px">
<?php 
	get_footer();
?>
</div>