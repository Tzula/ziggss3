...
if(!empty($_POST['Submit'])) {
	...
	//修改侧边栏显示的内容热门文章的标题和图片
	$mostViewdTemplate = trim('<li><a href="%POST_URL%"  title="%POST_TITLE%">%POST_TITLE%</a>'.
	 the_post_thumbnail('post-thumb').' views</li>');	

	$views_options['most_viewed_template'] = $mostViewdTemplate;
